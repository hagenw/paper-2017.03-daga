...
\begin{frame}{Beispiel: Open Science in der Akustik}
    ...
    Ziel: Evaluation verschiedener Audiowiedergabeverfahren
...
\begin{frame}{Publizieren in der Zukunft}
    ...
    \textbf{Ziel:} Daten und Code als Teil der Publikation
    ...
    \begin{figure}
        \centering
        \only<1>{\includegraphics[width=.8\textwidth]{phd}}
        \only<2>{\includegraphics[width=.8\textwidth]{jupyter}}
    \end{figure}
...
\begin{frame}{Zusammenfassung}
    ...
    \begin{itemize}
        \item Open Science wichtig bei Computer Simulationen
        \item $p$-Wert kritisch hinterfragen
        \item Paper nicht bestmögliche Publikationsform
    \end{itemize}

    Vielleicht besser nochmal die ``Auswege''-Folie zeigen?
