...
\begin{frame}{Beispiel: Open Science in der Akustik}
    ...
    Studien-Ziel: Evaluation verschiedener Audiowiedergabeverfahren
...
\begin{frame}{Beispiel: Open Science in der Akustik}
    ...
    \textbf{Daten}
    \begin{itemize}
        \item Datenrepository, z.B. zenodo.org
        \item Zeige Screenshot
        \item Gehe darauf ein, dass es noch nicht perfekt ist
    \end{itemize}
    \vspace{.2cm}
    \textbf{Software}
    \begin{itemize}
        \item Software Repository, z.B. auf github.org
        \item Sound Field Synthesis Toolbox
        \item Gute Idee: nicht nur für ein Paper, sondern allgemeiner und mit
            Partnern
    \end{itemize}
    \vspace{.2cm}
    \textbf{Methoden}
    \begin{itemize}
        \item Skripte für statistische Auswertung veröffentlichen (z.B.
            zenodo.org, oder github)
        \item Wäre auch gut, wenn man pro Abbildung den Code mit veröffentlichen
            würde (Beispiel Diss) [Überleitung Jupyter]
    \end{itemize}

\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Publikationen in der Zukunft}

    \begin{itemize}
        \item Code und Daten Teil der Publikation
        \item Kann weiter entwickelt werden
    \end{itemize}

    Zeige Jupyter-Screenshot als Beispiel
